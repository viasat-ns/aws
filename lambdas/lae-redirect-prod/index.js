    ...
    if( hostname == "energy.viasat.com" ) {
        const redirect_cb = {
            ...
            headers: {
                ...
                location: [{
                    key: 'Location',
                    value: ("https://www.viasat.com/enterprise-and-mobility/energy-services/"),
                }],
            },
        };
    ...
    if( hostname !== "www.viasat.com" ) {
        const redirect_cb = {
            ...
            headers: {
                ...
                location: [{
                    key: 'Location',
                    value: ("https://www.viasat.com" + url),
                }],
            },
        };
        console.log( "301 (53): " + url);
